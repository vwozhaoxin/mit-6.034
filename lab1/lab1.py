...
# family_rules.
family_rules = [ IF(AND('male (?x)','male (?x)'),THEN('(?x) (?x) same identity')),
                 IF(AND('female (?x)','female (?x)'),THEN('(?x) (?x) same identity')),
                 ...
                 IF(AND('parent (?x) (?y)','parent (?x) (?z)','female (?y)','female (?z)',NOT('(?y) (?z) same identity')),THEN ('sister (?y) (?z)')),
                 IF(AND('parent (?x) (?y)','parent (?x) (?z)','male (?y)','male (?z)',NOT('(?y) (?z) same identity')),THEN ('brother (?y) (?z)')),
                 IF(AND('parent (?x) (?y)','parent (?x) (?z)','female (?y)','male (?z)'),THEN ('sister (?y) (?z)')),
                 IF(AND('parent (?x) (?y)','parent (?x) (?z)','male (?y)','female (?z)'),THEN ('brother (?y) (?z)')),
                 ...
                 IF(AND('parent (?a) (?b)','parent (?c) (?d)',(OR('brother (?a) (?c)','sister (?a) (?c)'))),THEN('cousin (?b) (?d)'))]
                 
#                 IF(AND('female (?x)','male (?z)','parent (?y) (?x)','parent (?y) (?z)'),THEN ('sister (?x) (?z)')),
#                 IF(AND('female (?x)','female (?x)','parent (?y) (?x)','parent (?y) (?z)'),THEN ('sister (?x) (?x)')),
##                 IF(AND('male (?x)','male (?x)','parent (?y) (?x)','parent (?y) (?z)'),THEN ('brother (?x) (?z)')),
#                 IF(AND('male (?x)','female (?z)','parent (?y) (?x)','parent (?y) (?z)'),THEN ('brother (?x) (?z)'))]                    # fill me in
